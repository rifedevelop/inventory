...
(function (factory) {
	...
	$.extend(true, DataTable.ext.classes, {
		...
		search: {
			input: "border placeholder-gray-500 ml-2 px-3 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" //dark:bg-gray-800 dark:border-gray-600-OFF dark:focus:border-blue-500 dark:placeholder-gray-400
		},
		length: {
	...
	DataTable.ext.renderer.layout.tailwindcss = function (settings, container, items) {
		var row = $('<div/>', {
			"class": items.full ?
				...
				'flex flex-row justify-between gap-4 mb-4'
		})
			.appendTo(container);
